...
The way these markets work, is you have a constantly evolving <span style="color: purple;"> [***order book***](https://www.investopedia.com/terms/o/order-book.asp)</span>, where traders can post specific trades they want to make to either sell or buy a cryptocurrency specifying the price and quantity. When someone posts a trade to sell a cryptocurrency at a price that someone else is looking to purchase it at, a trade between the two parties will take place. Many people doing this at the same time creates an interesting dynamic where the two sides 

<!-- [TODO - FINISH THIS] -->

![](images/orderbook_ex.PNG)
