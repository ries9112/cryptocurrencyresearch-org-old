...
<!-- DISABLED BECAUSE OF GITHUB ACTIONS XQUARTZ NOT BEING DETECTED -->
<!-- ### Rayshader -->
...
<!-- ```{r rayshader_cal_heatmap, message=FALSE, warning=FALSE} -->
...
<!-- ```{r rayshader_render_movie, message=FALSE, warning=FALSE} -->
...
<!-- plot_gg(calendar_heatmap, zoom = 0.60, phi = 35, theta = 45) -->
<!-- # Render movie -->
<!-- render_movie('images/rayshader_video.mp4') -->
<!-- # Close RGL -->
<!-- rgl.close() -->
<!-- ``` -->
